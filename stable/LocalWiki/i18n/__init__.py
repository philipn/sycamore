# -*- coding: iso-8859-1 -*-
"""
    LocalWiki - Internationalization
    ...
    Public attributes:
    languages -- languages that LocalWiki knows about
...
def loadLanguage(request, lang):
    ...
    lang_module = "LocalWiki.i18n." + filename(lang)
...
def wikiLanguages():
    ...
    Return a dict containing a subset of LocalWiki languages ISO codes.
    """
