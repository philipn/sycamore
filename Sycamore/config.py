...
# Sycamore class library with pydoc, and is also friendly to people who for
# some reason forgot they need sycamore_config. 
default_config = 0
try:
...
smiley_defaults = {
    ...
    # version 1.1 (flags)
    # flags for the languages in Sycamore.i18n
