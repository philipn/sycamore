# -*- coding: iso-8859-1 -*-
"""
    Sycamore - Stand-alone HTTP Server
...
from Sycamore import config, version
from Sycamore.request import RequestStandAlone
...
class MoinRequestHandler(SimpleHTTPServer.SimpleHTTPRequestHandler):
    ...
    server_version = "Sycamore/" + version.revision
