...
class SubPageDisplayTest(RequestBasics):
    ...
    args_and_values = [
        ...
        (u'Front Page/Talk', [(u'Front Page', u'Front Page'),
                              (u'Front Page/Talk', u'Talk')]),
        (u'Templates', [(u'Templates', u'Templates')]),
        (u'Templates/Business', [(u'Templates', u'Templates'),
                                 (u'Templates/Business', u'Business')]),
        (u'Templates/Business/Talk', [(u'Templates', u'Templates'),
                                      (u'Templates/Business', u'Business'),
                                      (u'Templates/Business/Talk', 'Talk')]),
        ]
    ...
    def testSubpageRender(self):
        ...
        for pagename in impossible_pagenames:
            self.args_and_values.append((('Front Page/%s' % pagename),
                                         ([('Front Page', 'Front Page'),
                                           ('Front Page/%s' % pagename,
                                            pagename)])))
        for pagename in impossible_pagenames:
            self.args_and_values.append((('Front Page/%s/Talk' % pagename),
                                         ([('Front Page', 'Front Page'),
                                           ('Front Page/%s/Talk' % pagename,
                                            '%s/Talk' % pagename)])))
        for pagename in impossible_pagenames:
            self.args_and_values.append((('Templates/Business/%s' % pagename),
                                         ([('Templates', 'Templates'),
                                           ('Templates/Business', 'Business'),
                                           ('Templates/Business/%s' % pagename,
                                            pagename)])))
        for pagename in impossible_pagenames:
            self.args_and_values.append(
                (('Templates/Business/%s/Talk' % pagename),
                ([('Templates', 'Templates'),
                  ('Templates/Business', 'Business'),
                  ('Templates/Business/%s/Talk' % pagename,
                   '%s/Talk' % pagename)])))
        ...
        for pagename, values in self.args_and_values:
            self.assertEqual(
                subpagelinks.SubpageLinks(self.request, pagename).render(),
                values)
