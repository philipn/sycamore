...
""")
	...
	# write the editlog entry
		...
		# write the page-centric editlog entry
            ...
            os.spawnl(os.P_NOWAIT, config.app_dir + '/add_to_userstats', config.app_dir + '/add_to_userstats', str(config.tz_offset), config.app_dir, self.request.user.name, action, self.page_name)
