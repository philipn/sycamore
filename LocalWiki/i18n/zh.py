# -*- coding: utf-8 -*-
# Text translations for Chinese (zh).
...
'''如要创建自己的模板, 请新建一页, 名字要符合正规表达式 "%(page_template_regex)s"的规范.''',
...
'''在您编辑本页时, 有人修改保存了本页!
请勿直接保存您的改动!
请先点击%(difflink)s, 看看哪里被别人修改过了, 再决定是否进一步编辑、保存本页.''',
...
'''[本页当前大小为<strong>%(size)d</strong>字节]''',
'''Describe %s here.''':
'''在这里编辑"%s".''',
...
'''按下"<strong>%(save_button_text)s</strong>"表示您同意受%(license_link)s规定之约束.
如果你不同意, 按"<strong>%(cancel_button_text)s</strong>"取消您的修改.''',
'''Preview''':
'''预览''',
...
''':
'''<dt>强调:</dt>
<dd>\'\'<em>斜体</em>\'\'; \'\'\'<strong>粗体</strong>\'\'\'; \'\'\'\'\'<strong><em>粗斜体</em></strong>\'\'\'\'\';
    \'\'<em>混合\'\'\'<strong>粗</strong>\'\'\'斜体</em>\'\'; ---- 分隔线.</dd>
<dt>标题:</dt>
<dd>= 标题 1 =; == 标题 2 ==; === 标题 3 ===;
    ==== 标题 4 ====; ===== 标题 5 =====.</dd>
<dt>列表:</dt>
<dd>空格加下列符号之一：* 表圆点; 1., a., A., i., I. 表序数项;
    1.#n 表由n开始计数; 只用空格 表缩排.</dd>
<dt>链接:</dt>
<dd>JoinCapitalizedWords 两个以上大写开头字; ["方括号加双引号"];
    url; [url]; [url 说明].</dd>
<dt>表格:</dt>
<dd>|| 单元格文字 |||| 单元格文字横跨两列 ||;
    表格或标题后不可以有空格.</dd>
...
您收到此邮件是因为您在"%(sitename)s"订阅了wiki页面或wiki类别的改动通知服务.
...
''':
'''很抱歉, 在您编辑时别的用户修改保存了本页.<p>请按如下步骤: 使用您浏览器的回退键, 从那里拷贝粘贴
...
'''您不能修改本页的访问控制表(ACL), 因为您没有管理权限!''',
'''Thank you for your changes. Your attention to detail is appreciated.''':
'''谢谢修改, 敬请注意细节.''',
'''The lock of %(owner)s timed out %(mins_ago)d minute(s) ago, and you were granted the lock for this page.''':
'''%(owner)s对本页的编辑锁定在%(mins_ago)d分钟前已经失效了,现在您锁定了本页的编辑.''',
'''Other users will be <em>blocked</em> from editing this page until %(bumptime)s.''':
'''其他用户在%(bumptime)s之前, <em>无权</em>修改本页.''',
...
'''本wiki不支持邮件处理, 请联系管理员, 以便他决定是否要启动邮寄功能,或是干脆去掉「订阅」图示.''',
...
'''本页包含 <a href="%(link)s">%(count)s 个附件</a>.''',
...
'''<p>如果要在正文中引用附件, 请参考下表, 输入<strong><tt>attachment:filename</tt></strong> 这种格式,<strong>请不要</strong>用<tt>[下载]</tt>指向的 URL, 因为那个位置可能会变, 到时候就不能用了.</p>''',
'''del''':
'''删除''',
'''get''':
'''下载''',
