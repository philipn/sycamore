...
def execute(macro, args):
    ...
    if args:
       ...
       dom = xml.dom.minidom.parse(config.app_dir + "/userstats.xml")
       users = dom.getElementsByTagName("user")
       htmltext.append('<p><h2>User Statistics</h2></p><table width=100%% border=0><tr><td><b>User</b></td><td><b>Edits&nbsp;&nbsp;</b></td><td><b>Pages Created&nbsp;&nbsp;</b></td><td><b>Images Contributed&nbsp;&nbsp;</b></td><td><b>Date Joined&nbsp;&nbsp;</b></td><td><b>Last Edit&nbsp;&nbsp;</b></td><td><b>Last Page Edited&nbsp;&nbsp;</b></td></tr>')
       for user in users:
          list.append(user) 
