...
__revision__ = "$Id: option_parser.py,v 1.2 2003/01/30 02:24:26 jhermann Exp $"
...
import sys, os
import types
from LocalWiki.support.optik.option import Option, NO_DEFAULT
from LocalWiki.support.optik.help import IndentedHelpFormatter
from LocalWiki.support.optik.errors import OptionConflictError, OptionValueError, BadOptionError
