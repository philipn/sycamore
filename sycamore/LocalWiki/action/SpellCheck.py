...
"""  
    ...
    LocalWiki looks for dictionary files in the directory "dict" within the
    LocalWiki package directory. To load the default UNIX word files, you
