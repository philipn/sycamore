...
'''שייך את הדף לקטגוריה %(category)s''',
'''Check Spelling''':
'''בדוק איות''',
'''Save Changes''':
'''שמור שינויים''',
...
'''Show page trail''':
'''הצג דפים אחרונים שביקרתי בהם''',
'''Show icon toolbar''':
'''הצג שורת כלים''',
'''Show top/bottom links in headings''':
'''הצג קישורים למעלה ולמטה בכותרות''',
'''Show fancy diffs''':
'''הצג הבדלים יפים''',
...
'''<a href="%(link)s">%(count)s קבצים מצורפים</a> לדף''',
...
'''אין לכם הרשאות לקבל קבצים מצורפים מהדף''',
'''You are not allowed to view attachments of this page.''':
'''אין לכם הרשאות לצפות בקבצים מצורפים בדף''',
...
'''קובץ מצורף "%(filename)s" נמחק.''',
'''Attachment \'%(filename)s\'''':
'''קובץ מצורף "%(filename)s".''',
...
'''ציפיתי למספר שלם "%(key)s" לפני "%(token)s"''',
